...
public class MembersListStep7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableFixHeaders.setAdapter(new ContentTableAdapter(MembersListStep7Activity.this, pensionerObjectArrayList));

        closeViewIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MembersListStep7Activity.this.finish();
            }
        });
