...
public class MembersListStep5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableFixHeaders.setAdapter(new ContentTableAdapter(MembersListStep5Activity.this, pensionerObjectArrayList));
